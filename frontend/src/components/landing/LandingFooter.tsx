		...
		<footer className="bg-navy text-white/80">
			<div className="max-w-7xl mx-auto px-5 sm:px-8 py-12 grid grid-cols-2 md:grid-cols-5 gap-8">
				<div className="col-span-2">
					...
					<p className="mt-3 text-[13px] text-white/55 max-w-xs">
						Offline-first classroom records for Philippine public
						school teachers.
					</p>
				...
				<div>
					...
					<ul className="space-y-2 text-[13px]">
						...
						<li>
							<a href="#deped" className="hover:text-white">
								DepEd alignment
							</a>
						</li>
						<li>
				...
				<div>
					...
					<ul className="space-y-2 text-[13px]">
						...
						<li>
							<a
								href="mailto:hello@aralsync.com"
								className="hover:text-white"
							>
								hello@aralsync.com
							</a>
			...
			<div className="border-t border-white/10">
				<div className="max-w-7xl mx-auto px-5 sm:px-8 py-5 flex items-center justify-between flex-wrap gap-3 text-[12px] text-white/40">
					<span>©2026 AralSync · v1.0.0 (Beta)</span>
					<div className="flex items-center gap-5">
						...
						<a href="/data-policy" className="hover:text-white">
							Data policy
						</a>
					</div>
				</div>
